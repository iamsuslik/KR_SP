...
std::string ErrorUtils::statusCodeToString(StatusCode code) {
  switch (code) {
    ...
    case StatusCode::TABLE_NOT_FOUND:
      return "Table not found";
    case StatusCode::DATABASE_NOT_FOUND:
      return "Database not found";
    case StatusCode::COLUMN_NOT_FOUND:
      return "Column not found";
    case StatusCode::TYPE_MISMATCH:
      return "Data type mismatch";
    case StatusCode::DUPLICATE_KEY:
      return "Unique constraint violation (Duplicate key)";
    case StatusCode::NOT_NULL_VIOLATION:
